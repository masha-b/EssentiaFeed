...
//  EssentialFeedTests
//
//  Created by Maria Biryukova on 12.01.2022.
//
...
class CacheFeedUseCaseTests: XCTestCase {
    ...
    private func expect(_ sut: LocalFeedLoader, toCompleteWithError expectedError: Error?, when action: () -> (), file: StaticString = #file, line: UInt = #line) {
