...
class LoadFeedRemoteUseCaseTests: XCTestCase {
    ...
    func test_load_deliversNoItemsOn200HTTPResponseWithJSONItems() {
       ...
       let items = [item1.modele, item2.modele]
    ...
    private func makeItem(id: UUID, description: String? = nil, location: String? = nil, imageURL: URL) -> (modele: FeedImage, json: [String: Any]) {
        let item = FeedImage(
            id: id,
    ...
    private func expect(_ sut: RemoteFeedLoader, toCompleteWith expectedResult: RemoteFeedLoader.Result, when action: () -> (), file: StaticString = #file, line: UInt = #line) {
