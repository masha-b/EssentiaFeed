...
//
//  Created by Maria Biryukova on 07.01.2022.
//
...
class EssentialFeedApiEndToEndTests: XCTestCase {
    ...
    func test_endToEndTestServerGETFeedResult_matchesFixedTestAccauntData() {
        switch getFeedResult() {
        case .success(let imageFeed)?:
            XCTAssertEqual(imageFeed.count, 8, "Expected 8 images in the test accaunt image feed")
